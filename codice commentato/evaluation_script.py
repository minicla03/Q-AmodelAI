...
results = []  # Lista per memorizzare i risultati dei test

# Test case per valutare il sistema QA
TEST_CASES = [
    {
...
if results:
    ...
    # Salva le metriche medie su file
